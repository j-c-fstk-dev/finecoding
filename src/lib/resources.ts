...
const hardcodedRepositories: Resource[] = [
    // New No-Code Tools
    {
        id: 'webflow-nocode',
        name: 'Webflow',
        description: 'Ferramenta de design e desenvolvimento no-code que permite criar sites totalmente personalizados, com recursos avançados de animação e CMS.',
    ...
    },
    {
        id: 'bubble-nocode',
        name: 'Bubble',
        description: 'Plataforma poderosa para construir aplicativos web, permitindo criar desde sites simples até aplicações complexas.',
    ...
    },
    {
        id: 'adalo-nocode',
        name: 'Adalo',
        description: 'Ideal para criar aplicativos móveis (iOS e Android) e web apps sem código.',
        link: 'https://www.adalo.com/',
        category: 'No-Code',
        pricing: 'Free Tier',
        icon: 'Component',
        createdAt: new Date('2024-08-02T08:00:00Z'),
        favorites: 1800,
    },
    {
        id: 'zapier-automation',
        name: 'Zapier',
        description: 'Conecta aplicativos e automatiza tarefas entre eles, permitindo criar fluxos de trabalho sem a necessidade de código.',
        link: 'https://zapier.com/',
        category: 'Automation',
        pricing: 'Free Tier',
        icon: 'Zap',
        createdAt: new Date('2024-08-02T07:00:00Z'),
        favorites: 3500,
    },
    {
        id: 'make-automation',
        name: 'Make (Integromat)',
        description: 'Plataforma para conectar aplicativos e automatizar processos, oferecendo um controle visual e detalhado dos fluxos de trabalho.',
        link: 'https://www.make.com/',
        category: 'Automation',
        pricing: 'Free Tier',
        icon: 'Zap',
        createdAt: new Date('2024-08-02T06:00:00Z'),
        favorites: 3000,
    },
    {
        id: 'shopify-ecommerce',
        name: 'Shopify',
        description: 'Plataforma completa para a criação de lojas virtuais, gerenciamento de produtos e processamento de pagamentos.',
        link: 'https://www.shopify.com/',
        category: 'E-commerce',
        pricing: 'Paid',
        icon: 'Component',
        createdAt: new Date('2024-08-02T05:00:00Z'),
        favorites: 4000,
    },
    {
        id: 'stripe-ecommerce',
        name: 'Stripe',
        description: 'Plataforma de pagamentos online que permite a integração de soluções de cobrança em sites e aplicativos.',
        link: 'https://stripe.com/',
        category: 'E-commerce',
        pricing: 'Paid',
        icon: 'Component',
        createdAt: new Date('2024-08-02T04:00:00Z'),
        favorites: 3800,
    },
    {
        id: 'airtable-db',
        name: 'Airtable',
        description: 'Uma planilha poderosa que funciona como um banco de dados, com a flexibilidade de organizar informações de forma visual.',
        link: 'https://www.airtable.com/',
        category: 'APIs & Backends',
        pricing: 'Free Tier',
        icon: 'Server',
        createdAt: new Date('2024-08-02T03:00:00Z'),
        favorites: 3200,
    },
    {
        id: 'typeform-nocode',
        name: 'Typeform',
        description: 'Ferramenta para criar formulários, pesquisas e quizzes interativos e visualmente atraentes.',
        link: 'https://www.typeform.com/',
        category: 'No-Code',
        pricing: 'Free Tier',
        icon: 'Component',
        createdAt: new Date('2024-08-02T02:00:00Z'),
        favorites: 2600,
    },
    {
        id: 'xano-backend',
        name: 'Xano',
        description: 'Back-end no-code que permite criar APIs escaláveis para seus aplicativos.',
        link: 'https://www.xano.com/',
        category: 'APIs & Backends',
        pricing: 'Free Tier',
        icon: 'Server',
        createdAt: new Date('2024-08-02T01:00:00Z'),
        favorites: 1500,
    },
